...
public class Description_Annotation {
	...
	@Test(description = "Launch the URL")
	public void browser() {
		Utility_Files.url_Launch("https://www.facebook.com/");
	}

	@Test(priority = 1, description = "Mamize the broweser")
	public void maximize() {
		Utility_Files.manage_Commands("maximize");
	}

	@Test(priority = 2, description = "refresh the webpage")
	public void refresh() {
		Utility_Files.manage_Commands("refresh");
	}

	@Test(priority = 3, description = "Entered email address")
	...
	@Test(priority = 4, description = "entered password")
	...
	@Test(priority = 5, description = "clicked Login Button")
